<template>
  <a-layout>
    <a-layout-sider class="layout-sider" collapsible v-model:collapsed="collapsed">
      <div :class="clxs('w-full h-10 flex  items-center overflow-hidden pl-2',collapsed ? 'justify-center' : '')"> 
       <img style="width: 27px;height: 24px;" src='https://raw.githubusercontent.com/InhiblabCore/vue-hooks-plus/master/packages/hooks/docs/public/logo.png' alt=""> 
       <span v-show="!collapsed" class="w-30 whitespace-nowrap pl-2 font-[700] text-lg">Vue Admin Novel</span>
      </div>
      <a-menu
        mode="inline"
